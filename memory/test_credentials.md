...
1. Go to: https://blr-trend-mag.emergent.host/login
2. Login with admin credentials above

## Password Reset (Email-based)
- Uses Gmail SMTP with bfm1magazine@gmail.com
- Requires GMAIL_APP_PASSWORD in backend/.env
- Access at: /reset-password
