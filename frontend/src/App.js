      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            <span className="font-serif text-lg font-bold text-[#F5F5F0]">Bangalore Fashion</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              <>
                {isAdmin && (
                  <Link to="/admin" className="px-3 py-1.5 bg-[#D4AF37] text-[#050A14] text-xs uppercase rounded flex items-center gap-1">
              ...
              <>
                ...
                <Link to="/join" className="px-3 py-1.5 border border-[#D4AF37] text-[#D4AF37] text-xs uppercase rounded hover:bg-[#D4AF37] hover:text-[#050A14]">
                  Join Us
                </Link>
              </>
            )}
